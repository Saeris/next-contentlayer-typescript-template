  ...
  mdx: {
    ...
    rehypePlugins: [
      ...
      [
        ...
        {
          inspectEach(url) {
            url.node.properties.src = `/${path.join(url.file.data.rawDocumentData.sourceFileDir, url.url)}`.replace(/\\/g, `/`);
          },
          selectors: [`img[src]`]
        }
      ],
...
//# sourceMappingURL=compiled-contentlayer-config-K37NPM5M.mjs.map
