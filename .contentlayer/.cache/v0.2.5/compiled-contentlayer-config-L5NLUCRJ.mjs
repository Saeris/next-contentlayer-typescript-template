  ...
  mdx: {
    ...
    rehypePlugins: [
      ...
      [
        ...
        {
          inspectEach(url) {
            const src = `/${path.join(url.file.data.rawDocumentData.sourceFileDir, url.url)}`.replace(new RegExp(`\\`, "g"), `/`);
            console.log(src);
...
//# sourceMappingURL=compiled-contentlayer-config-L5NLUCRJ.mjs.map
